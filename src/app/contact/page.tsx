...
const contactData = [
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 40 32"><path xmlns="http://www.w3.org/2000/svg" fill="#fff" d="m8.672 3.727 9.953 13.539L8.609 28.273h2.254l8.77-9.636 7.086 9.636h7.672l-10.516-14.3 9.324-10.246h-2.254l-8.074 8.875-6.527-8.875Zm3.316 1.691h3.524l15.562 21.164h-3.523Zm0 0" /></svg>
        ),
        platform: "X",
        name: "nikosszzz",
