        ...
        <section className={`${padding.XY} relative w-full`} id="about">
            ...
            <div className="text-2xl">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="bg-gradient-to-r from-[#686c6d] via-[#292e2e] to-[#111717] rounded-3xl mr-auto ml-auto mb-5">
                        <Image src="https://skillicons.dev/icons?i=react,electron,nextjs,nodejs,ts,js,html,css,kotlin,tauri" height={48} width={512} alt={"My actively used languages & frameworks"} className="p-2" />
                    </div>  
                </div>
